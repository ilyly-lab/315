...
public class Init {
    ...
    public void initializedDataBase() {
        ...
        userService.saveUser(new User( "Admin","Abrosimov", "admin@yandex.com","+7944452533", "100" , adminRole));
        userService.saveUser(new User( "User", "Userov", "user@gmail.com","+79774562422", "100", userRole));
        userService.saveUser(new User("Trans", "Transov", "trans@rambler.com","+75551235788", "100", allRoles));
    }
}
